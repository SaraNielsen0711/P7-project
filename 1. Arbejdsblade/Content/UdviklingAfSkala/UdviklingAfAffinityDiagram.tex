...
%
%OBS: SKRIV LIGE AT VI BRUGER VAS BI- OG UNIPOLÆR, HUSK AT SKRIV HVORDAN DE BYGGES OP
...
Først vil hver af de 10 grønne kategorier blive præsenteret sammen med tilhørende potentielle skala spørgsmål, efterfulgt af tilhørende skala labels. For hvert potentielt skala spørgsmål vil det blive besluttet hvorvidt den specifikke parameter skal evalueres på en bipolær eller på en unipolær \textit{Visual Analoge Scale}, (VAS) med åbne endepunkter. I tilfælde hvor parameteren evalueres på en bipolær skala vil der være markeret et midt punkt, som enten kan være unavngivet eller navngivet. Derefter vil der fokuseres på udvælgelsen af de endelige skalaer.
\newpage 
%
...
\begin{enumerate}
  ...
  \item Jeg føler R kan hjælpe mig
...
\begin{enumerate}
  ...
  \item Jeg synes R's hastighed er... 
...
\noindent
%
%TJEK AT DET ER RIGTIG AT DE BLEV SLÅET SAMMEN FØRST
Det vælges at sammensætte \textit{Jeg blev nysgerrig da jeg så R} med \textit{R fangede min opmærksomhed} til ét potentielt skala spørgsmål, da det antages at de vedrører det samme. De to potentielle skala spørgsmål er som følger: \blankline
%
\begin{enumerate}
  \item R fangede min opmærksomhed
  \item Jeg synes R er spændende\blankline
\end{enumerate}
%
