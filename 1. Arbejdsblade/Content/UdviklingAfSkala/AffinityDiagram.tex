...
%
Det tilstræbes så vidt muligt at følge reglerne og processen for fortolkningssessionen, den vil dog tilpasses afhængigt af behov. Eksempelvis vil \textit{affinity notes} ikke nedskrives i en teksteditor for derefter at blive printet ud. De vil derimod blive nedskrevet direkte på \textit{sticky notes}.
