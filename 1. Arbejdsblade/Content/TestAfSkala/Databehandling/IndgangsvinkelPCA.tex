\section{Principal Component Analysis: Indgangsvinkel}
...
\end{tabular}
\caption{Oversigt over \textit{loadings} til de tre PCs, for hver PC fremhæves den mest betydende parameter. \textit{SQ} angiver skalaspørgsmålet.}
