...
\caption{\textit{Scree}-plot, hvorpå sammenhængen mellem antallet af \textit{Principal Components} og \textit{Variance Explained [\%]} fremgår. Bidraget for hver PC er som føler: PC1 29.9 \%, PC2 13.4 \%, PC3 9.8 \%, PC4 8.5 \%, PC5 6.4 \%, PC6 5.4 \% og PC7 4.8 \%.}
\label{fig:Scree}
\end{figure}
\noindent
%
