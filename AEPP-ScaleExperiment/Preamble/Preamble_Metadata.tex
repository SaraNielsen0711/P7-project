...
\newcommand{\projectname}{Skaleringseksperiment}
\newcommand{\projectnameextension}{- Påvirker robottens hovedposition hvor indbydende robotten perciperes -} % Eventually leave empty
...
\newcommand{\finishdate}{12. Oktober}
