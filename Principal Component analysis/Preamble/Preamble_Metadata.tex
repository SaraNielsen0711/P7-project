...
\newcommand{\projectname}{Principal Component Analysis}
\newcommand{\projectnameextension}{- On data from Men and Bread -} % Eventually leave empty
...
\newcommand{\finishdate}{December 7th.}
