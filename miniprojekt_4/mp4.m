...
text(Y2(1,1),Y2(1,2) ,'Grief at death of mother', 'FontSize',12)
text(Y2(2,1),Y2(2,2) ,'Savoring a coke', 'FontSize',12)
text(Y2(3,1),Y2(3,2) ,'Very pleasant surprise', 'FontSize',12)
text(Y2(4,1),Y2(4,2) ,'Maternal love-baby in arms', 'FontSize',12)
text(Y2(5,1),Y2(5,2) ,'Physical exhaustion', 'FontSize',12)
text(Y2(6,1),Y2(6,2) ,'Something wrong with the plane', 'FontSize',12)
text(Y2(7,1),Y2(7,2) ,'Anger at seeing dog beaten', 'FontSize',12)
text(Y2(8,1),Y2(8,2) ,'Pulling hard on seat of chair', 'FontSize',12)
text(Y2(9,1),Y2(9,2) ,'Unexpectedly meets old boy friend', 'FontSize',12)
text(Y2(10,1),Y2(10,2) ,'Revulsion', 'FontSize',12)
text(Y2(11,1),Y2(11,2) ,'Extreme pain', 'FontSize',12)
text(Y2(12,1),Y2(12,2) ,'Knows plane will crash', 'FontSize',12)
text(Y2(13,1),Y2(13,2) ,'Light sleep', 'FontSize',12)
xlabel('Dimension 1')
ylabel('Dimension 2')
