...
\input{Content/MethodElicitation.tex}
\input{Content/CopyResultsElicitation.tex}
\input{Content/MethodScaleTesting.tex}
\input{Content/ResultsScaleTesting.tex}
...
% Watch out that the combined width of al<l the subfigures on a 
