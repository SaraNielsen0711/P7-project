...
This study further aims to develop relevant scales based on the elicitated variables which can be used by designers when developing the robots to a specific context. This will promot a tailored user experience.
