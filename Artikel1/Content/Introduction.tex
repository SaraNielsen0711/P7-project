...
This study aims to elicitate important variables in social robot interaction at an airport and develop relevant scales based on these variables. Furthermore the study aims to analyse if some variables have an influence on others. When scales are developed and tested designers might be able to use them to develop robots for specific contexts and potentially for tailored user experience evaluations.
