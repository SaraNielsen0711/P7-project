...
\end{itemize}
%
The scale questions can either be presented on a uni- or bipolar \textit{Visual Analoge Scale} (VAS) with open anchor points. If the scale is bipolar a midt point will be marked as shown on \autoref{fig:Height}.
%
\begin{figure}[H]
\centering
