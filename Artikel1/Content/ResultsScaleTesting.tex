...
\begin{figure*}[!t]
\centering
\subfloat[Scree Plot of Robot Height]{\includegraphics[width=2.5in]{Figure/Scree.png}
\label{fig:Scree}}
\hfil
\subfloat[Biplot of Robot Height]{\includegraphics[width=2.5in]{Figure/RHeight-Biplot.png}
	\label{fig:biplot}}
...
%\begin{figure*}[!t]
%\centering
%\subfloat[Case I]{\includegraphics[width=2.5in]{Figure/Scree.png}
%\label{fig_first_case}}
%\hfil
%\subfloat[Case II]{\includegraphics[width=2.5in]{Figure/RHeight-Biplot.png}
%\label{fig_second_case}}
%\caption{}
%\label{fig_sim}
%\end{figure*}
