...
The physical parameters can be compared with SQs as well as the demographic parameters in the same manner as comparing SQs with each other. \autoref{fig:HeightSQ6} shows SQ6 compared with the robot's height, which shows that when the robot's height increases the robot is perceived as less annoying. Within Age small tendencies were noted. When comparing SQ6 with Age, the older a person is, the more inclined one is to rate the robot as going too fast. Also a small negative correlation was noted in relation to how exciting (spændende) the robot seemed. The older the subjects were, the less exciting they rated the robot. This same small tendency was seen with how funny (sjov) they rated the robot. Within Height the smaller the robot was the faster and more wild it was rated. This was expected as the robot is programmed from factory to move more slowly when the height increases and faster when it is low. Additionally it was rated more cute when it was small.

{\color{red} Har tilføjet lidt til demografi her, men det bør nok rettes igennem :)}
%
\begin{figure}[H]
	\centering
