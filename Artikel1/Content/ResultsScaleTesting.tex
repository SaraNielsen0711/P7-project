...
The physical parameters can be compared with SQs as well as the demographic parameters in the same manner as comparing SQs with each other. \autoref{fig:HeightSQ6} shows SQ6 compared with the robot's height, which shows that when the robot's height increases the robot is perceived as less annoying. A small tendency was noted when comparing SQ6 with Age. The older a person is, the more inclined one is to rate the robot as going too fast. Also a small negative correlation was noted 

{\color{red} skriv nogle eksempler fra hvordan robotten ellers perciperes med hensyn til demografi.}
%
\begin{figure}[H]
	\centering
