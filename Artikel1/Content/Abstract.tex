...
In the first test the observations and the subjects' statements was interpreted and coded using an affinity diagram. 567 affinity notes were sorted by a bottom-up procedure into ten categories from which the 24 scale questions and scales were developed. \fxnote{må være mellem 150-250 ord. Kilde: \url{https://www.ieee.org/publications_standards/publications/abstract_description.pdf}}
