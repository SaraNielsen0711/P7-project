...
None or few SST                      & BTL may fit                                   \\
Some SST and few MST                 & Preference-tree might fit (Not BTL)           \\
Considerable SST and MST but few WST & Possible to rank order (no model will fit)    \\ \bottomrule
\end{tabular}
