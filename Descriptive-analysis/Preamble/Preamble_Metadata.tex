...
\newcommand{\projectname}{Descriptive Analysis}
\newcommand{\projectnameextension}{- Udled attributter, der beskriver oplevelsen med en robot -} % Eventually leave empty
...
\newcommand{\finishdate}{16. November}
